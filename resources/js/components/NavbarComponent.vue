                ...
                <div class="dropdown show">
                    ...
                    >
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <a
                                class="nav-link-currency"
                                @click.prevent="saveCurrency('AUD')"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
                                ...
                                >
                                    ...
                                    <path
                                        fill="red"
                                        d="M14 32h4v-8h14v-4.667L18 20v-9h-4v9L.228 19.409A14.963 14.963 0 0 0 0 22v2h14v8z"
                                    />
                                    <path
                                        fill="red"
                                    ...
                                    <path
                                        fill="red"
                                        d="M32 29.72v-.038L22.83 25zM9.242 25L0 29.753v1.527L12.282 25z"
                                    />
                                    <path
                                        fill="red"
                                        d="M0 29.73v.023L9.242 25z"
                                    />
                                    <path
                                        fill="#fff"
