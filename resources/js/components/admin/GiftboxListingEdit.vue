                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb pl-0">
                        <li class="breadcrumb-item">
                            <router-link to="/admin/giftboxes">
                                Giftboxes
                            </router-link>
                        </li>
...
export default {
    ...
    methods: {
        ...
        cancel() {
            this.$router.push("/admin/giftboxes");
        },
        ...
        loadDetails() {
            axios
                .get("/api/admin/giftboxes/details")
                .then((response) => {
        ...
        loadProduct() {
            axios
                .get("/api/admin/giftboxes/" + this.$route.params.productId)
                .then(({ data }) => {
                    //this.form.fill(data);
        ...
        updateProduct() {
            ...
            this.form
                .put("/api/admin/giftboxes/" + this.form.id)
                .then(() => {
