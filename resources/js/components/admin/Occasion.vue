            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-secondary">
                    ...
                    <form
                        class="input-form"
                        @submit.prevent="
                            editMode ? updateOccasion() : createOccasion()
                        "
                    >
...
export default {
    ...
    methods: {
        ...
        editModal(occasion) {
            ...
            this.form.reset();
            $("#addRecord").modal("show");
            this.form.fill(occasion);
        },

        loadOccasions() {
            axios
                .get(
                    "/api/admin/occasions?page=" + this.pagination.current_page,
                    {
        ...
        updateOccasion() {
            this.form
                .put("/api/admin/occasions/" + this.form.id)
                .then(() => {
                    $("#addRecord").modal("hide");
                    Fire.$emit("reloadRecords");
                })
