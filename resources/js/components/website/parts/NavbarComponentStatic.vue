        ...
        >
            ...
            <div class="hide-content navbar-main-menu navbar-main-menu-mobile">
                <div class="d-flex align-items-center">
                    ...
                    <a href="/" class="navbar-brand mr-4 ml-3">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="/" class="navbar-brand mr-4 navbar-brand-desktop">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 805.67 156.56"
                >
                ...
                >
                    ...
                    <li class="nav-item mx-2">
                        <div class="dropdown dropdown-2">
                            <a class="nav-link dropbtn-2"> Recipients </a>
                    ...
                    <li class="nav-item mx-2">
                        <div class="dropdown dropdown-3">
                            <a class="nav-link dropbtn-3"> Occasions </a>
