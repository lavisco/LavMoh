    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <section id="2" class="mb-5">
                <h1 class="text-left">02 - Interpretation and Definitions</h1>
                <h2 class="text-left mb-4">Interpretation</h2>
                <p>
                ...
                <h2 class="text-left mb-4 mt-5">Definitions</h2>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            refers to Lavisco, 71, Kurunegala Rd,Katugastota
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Lavisco,
                            accessible from
                            <a
                                href="https://lavisco.lk"
            ...
            <section id="3" class="mb-5">
                <h1 class="text-left">
                    03 - Collecting and Using Your Personal Data
                </h1>

                <h2 class="text-left mb-4">Types of Data Collected</h2>
                <h4 class="black mb-4">Personal Data</h4>
                <p>
                ...
                <h4 class="black mb-4">Usage Data</h4>
                <p>
                ...
                <h4 class="black mb-4">Tracking Technologies and Cookies</h4>
                <p>
                ...
                <h2 class="text-left mb-4 mt-5">Use of Your Personal Data</h2>
                <p>
                ...
                <h4 class="black mb-4">Business Transactions</h4>
                <p>
                ...
                <h4 class="black mb-4">Law enforcement</h4>
                <p>
                ...
                <h4 class="black mb-4">Other legal requirements</h4>
                <p>
            ...
            <section id="4" class="mb-5">
                <h1 class="text-left">04 - Children's Privacy</h1>
            ...
            <section id="5" class="mb-5">
                <h1 class="text-left">05 - Links to Other Websites</h1>
            ...
            <section id="6" class="mb-5">
                <h1 class="text-left">02 - Changes to this Privacy Policy</h1>
