...
<h1>Your Lavisco Order {{ $order->code }} is being prepared</h1>
<p class="mb-4">
    Hello {{ $order->first_name }},
    <br />
    Your order from {{ $order->shop->name }} is currently being prepared, and
    will be delivered on {{ $order->delivery_date }}.
    <br />
