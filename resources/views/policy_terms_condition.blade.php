...
<div class="container-fluid">
    ...
    <div class="container">
        <section>
            ...
            >
            <a href="#5"><h6>05 - Modifications to the service/prices</h6></a>
            <a href="#6"><h6>06 - Products or services</h6></a>
        </section>
        <section id="1">
            <h1 class="text-left">01 - Overview</h1>
            <p>
                This website is operated by Lavisco. Throughout the site, the
                terms “we”, “us” and “our” refer to lavisco. Lavisco offers this
                ...
                of any changes constitutes acceptance of those changes. Our
                store is hosted on WooCommerce. They provide us with the online
                e-commerce platform that allows us to sell our products and
                services to you.
            </p>
        </section>
        <section id="2">
            <h1 class="text-left">02 - Online store terms</h1>
            <p>
        ...
        <section id="3">
            <h1 class="text-left">03 - General conditions</h1>
            <p>
        ...
        <section id="5">
            <h1 class="text-left">05 - Modifications to the service/prices</h1>
            <p>
        ...
        <section id="6" class="mb-5">
            ...
            <p>
                ...
                corrected. Delivery Terms and Guarantee Delivery of all our
                products is free island-wide for invoices or purchases valued at
                LKR 1500 and above. Cash on delivery is available for products
                that are not customized. Depending on the location, your order
                will be sent through our delivery partners or through parcel
                post(Srilanka Post) We guarantee your delivery within 5 working
                days (Maximum 7 days). If you do not receive your order within 7
                days of ordering, you reserve the right to cancel the order and
                receive a full refund (if applicable) or to receive the order
                for free ( Bulk orders and orders valued at LKR 5000 does not
                include). Our products mostly are fragile. We take all necessary
                steps to ensure that the product is safe and undamaged
                throughout the delivery process. Whereas you encounter a
                delivery that has been tampered or damaged you should notify us
                within 1 day of receiving. Upon confirming that the damage has
                occured during the delivery process we may refund or offer you
                to replace and deliver the order again for free of charge. This
                decision solely depends on the management team and their
                decision is final. In Case you failed to notify us of the damage
                you may be refused for a replacement of order or refund.
            </p>
        </section>
    </div>
</div>
